...
[![GenerateString](https://img.shields.io/badge/repl.it-generateString-brown)](https://replit.com/@Imteyazking01/WarbotZ#main.py)
...
- Some Of The Mandatory Vars Are :-
   ...
   - `STRING_NAME` :  Make a string session from [here](https://replit.com/@Imteyazking01/WarbotZ#main.py)
